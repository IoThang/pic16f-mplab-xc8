...
#define LCD_REG       PORTD                            // LCD register pin and select pin RS, RW and E
#define LCD_DB4       PORTDbits.RD4                  // LCD high order bus DB4-DB7
...
#define LCD_EN       PORTEbits.RE2                   // LCD enable
#define LCD_RW       PORTEbits.RE1                   // LCD read/write line
