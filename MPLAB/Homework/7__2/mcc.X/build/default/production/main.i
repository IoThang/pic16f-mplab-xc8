...
# 1 "C:/Program Files/Microchip/MPLABX/v6.00/packs/Microchip/PIC12-16F1xxx_DFP/1.3.90/xc8\\pic\\include\\__size_t.h" 1 3
...
void main(void)
{
    ...
    while (1)
    {
        ...
        temp = ADC_GetConversionResult() * 1.0 / 2.046;
        sprintf(x, "Temp=%.01f C", temp);
        LCDGoto(0,1);
        LCDPutStr(x);
    }
}
