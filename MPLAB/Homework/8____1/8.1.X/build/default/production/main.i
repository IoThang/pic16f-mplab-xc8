...
# 73 "main.c"
    while (1)
    {
        ...
        if((ch_buffer[0]=='B') && (ch_buffer[1]=='L') && (ch_buffer[2]=='I') && (ch_buffer[3]=='N') && (ch_buffer[4]=='K') && (ch_buffer[5]=='0') && (ch_buffer[7]=='#'))
        {
            ...
            if(led_blink == 1) {while(1){LATCbits.LATC0= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC0 = 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 2) {while(1){LATCbits.LATC1= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC1= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 3) {while(1){LATCbits.LATC2= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC2= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 4) {while(1){LATCbits.LATC3= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC3= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 5) {while(1){LATCbits.LATC4= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC4= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 6) {while(1){LATCbits.LATC5= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC5= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 7) {while(1){LATCbits.LATC6= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC6= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
            else if(led_blink == 8) {while(1){LATCbits.LATC7= 1; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATCbits.LATC7= 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;}}
        }
        else if((ch_buffer[0]=='B') && (ch_buffer[1]=='L') && (ch_buffer[2]=='I') && (ch_buffer[3]=='N') && (ch_buffer[4]=='K') && (ch_buffer[5]=='*') && (ch_buffer[6]=='#'))
        {
            while(1)
            {
                LATC = 0b11111111; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break; LATC = 0; _delay((unsigned long)((500)*(1000000/4000.0))); if(RCIF) break;
            }
